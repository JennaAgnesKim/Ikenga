...
public class UploadingPage extends JFrame {
	...
	public UploadingPage() {
		...
		txfName.setFont(new Font("굴림", Font.PLAIN, 20));
		...
		tfPrice.setFont(new Font("굴림", Font.PLAIN, 20));
		...
		tefDescription.setFont(new Font("굴림", Font.PLAIN, 20));
		...
		label.setFont(new Font("굴림", Font.BOLD | Font.ITALIC, 13));
